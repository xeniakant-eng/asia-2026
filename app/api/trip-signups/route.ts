...
const VALID_TRIPS = new Set(["morocco", "vietnam", "skiMyoko", "skiDeerValley", "skiBig3", "panama", "houston", "azoresPortugal", "similanThailand", "centralVietnam", "mexicoPlaya", "taiwanApril", "hawaii", "disneyWorld", "fiveStans"]);
